              ...
              <CardContent className="space-y-4 sm:space-y-5 md:space-y-6 px-4 sm:px-6 pb-6 sm:pb-8">
                <div className="space-y-2.5 sm:space-y-3 slide-up">
                  <label htmlFor="service-select" className="text-xs sm:text-sm font-medium text-foreground block">
                    انتخاب نوع خدمات داربست و ساختمانی:
                  </label>
                  <Select value={selectedService} onValueChange={setSelectedService}>
                    <SelectTrigger 
                      id="service-select"
                      className="w-full text-right h-11 sm:h-12 text-sm sm:text-base smooth-hover" 
                      aria-label="انتخاب نوع خدمات داربست فلزی یا چادر برزنتی"
                    >
                ...
                {selectedService === 'scaffolding' && (
                  <section 
                    className="space-y-3 sm:space-y-4 p-4 sm:p-5 md:p-6 bg-secondary/50 rounded-lg border-2 border-construction/20 scale-in"
                    aria-labelledby="scaffolding-heading"
                  >
                    ...
                    <Button
                      ...
                      aria-label="ثبت درخواست خدمات داربست فلزی"
                    >
                ...
                {selectedService === 'tarpaulin' && (
                  <section 
                    className="space-y-3 sm:space-y-4 p-4 sm:p-5 md:p-6 bg-secondary/50 rounded-lg border-2 border-construction/20 scale-in"
                    aria-labelledby="tarpaulin-heading"
                  >
                    ...
                    <Button
                      ...
                      aria-label="خدمات چادر برزنتی به زودی"
                    >
