...
export const ContractorVerifications = () => {
  usePageTitle('تأیید پیمانکاران');
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-foreground">تأیید پیمانکاران</h1>
        <p className="text-muted-foreground mt-2">
          بررسی و تأیید درخواست‌های ثبت‌نام پیمانکاران
        </p>
      </div>
      ...
      <Dialog open={rejectDialogOpen} onOpenChange={setRejectDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>رد درخواست پیمانکاری</DialogTitle>
          </DialogHeader>
